...
from states.admin_states import CategoryStates, delADS
...
@category_router.message(Command('del_ad'))
async def del_ad(message: Message, state: FSMContext):
    await message.answer('Please, give me ads id!')
    await state.set_state(delADS.num_id)

@category_router.message(delADS.num_id)
async def get_id(message: Message, state: FSMContext):
    db.del_ads(message.text)
    await message.answer('DELETE ADS')
